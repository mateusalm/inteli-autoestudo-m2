...
router.post('/cursosinsert', urlencodedParser, (req, res) => {
  res.statusCode = 200
...
router.patch('/cursosupdate', urlencodedParser, (req, res) => {
...
router.delete('/cursosdelete', urlencodedParser, (req, res) => {
  let id = req.params['id']
